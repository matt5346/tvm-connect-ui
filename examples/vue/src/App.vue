...
<template>
  <template v-if="tvmConnectState.isReady">
    <template v-if="tvmConnectState.isUnsupportedNetwork">
      <button @click="() => tvmConnectUI.switchNetwork(everscaleNetwork)">
        Switch network
      </button>
    </template>
    <template v-else>
      ...
      <p>
        <button @click="tvmConnectUI.changeAccount">
          Change account
        </button>
      </p>
      <p>
        <button @click="testProvider">
          Test provider
        </button>
      </p>
      <p>
        <button @click="tvmConnectUI.disconnect">
          Disconnect
        </button>
      </p>
    </template>
  ...
  <template v-else>
    <button
      @click="() => tvmConnectUI.connect(everscaleNetwork)"
    >
      Connect
    </button>
  </template>
